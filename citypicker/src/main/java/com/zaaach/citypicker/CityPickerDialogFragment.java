...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private void initViews() {
        ...
        mAdapter = new CityListAdapter(getActivity(), mAllCities, mHistoryCities,mHotCities, locateState);
    ...
    private void initData() {
        ...
        //初始化历史记录城市
        if (mHistoryCities == null || mHistoryCities.isEmpty()) {
            mHistoryCities = new ArrayList<>();
            mHistoryCities.add(new HotCity("北京", "北京", "101010100"));
            mHistoryCities.add(new HotCity("上海", "上海", "101020100"));
            mHistoryCities.add(new HotCity("广州", "广东", "101280101"));
            mHistoryCities.add(new HotCity("深圳", "广东", "101280601"));
            mHistoryCities.add(new HotCity("天津", "天津", "101030100"));
            mHistoryCities.add(new HotCity("杭州", "浙江", "101210101"));
            mHistoryCities.add(new HotCity("南京", "江苏", "101190101"));
            mHistoryCities.add(new HotCity("成都", "四川", "101270101"));
            mHistoryCities.add(new HotCity("武汉", "湖北", "101200101"));
        }
        //初始化热门城市
        ...
        mAllCities.add(1, new HotCity("历史记录", "未知", "0"));
