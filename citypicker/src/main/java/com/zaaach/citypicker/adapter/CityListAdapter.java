...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    private static final int VIEW_TYPE_HISTORY     = 11;
    private static final int VIEW_TYPE_HOT     = 12;

    private Context mContext;
    private List<City> mData;
    private List<HotCity> mHotData;
    private List<HotCity> mHistoryData;
    ...
    public CityListAdapter(Context context, List<City> data, List<HotCity> historyData,List<HotCity> hotData, int state) {
        this.mData = data;
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case VIEW_TYPE_HISTORY:
                view = LayoutInflater.from(mContext).inflate(R.layout.cp_list_item_history_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        if (holder instanceof HistoryViewHolder){
            ...
            final City data = mData.get(pos);
            if (data == null) return;
            GridListAdapter mAdapter = new GridListAdapter(mContext, mHistoryData);
    ...
    public int getItemViewType(int position) {
        ...
        if (position == 1 && TextUtils.equals("历", mData.get(position).getSection().substring(0, 1)))
