 ...
 * 点播底部控制栏
 */
public class ZKVodControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public ZKVodControlView(@NonNull Context context) {
        super(context);
    }

    public ZKVodControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKVodControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
