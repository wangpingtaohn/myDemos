 ...
 * 准备播放界面
 */
public class ZKPrepareView extends FrameLayout implements IControlComponent {
    ...
    public ZKPrepareView(@NonNull Context context) {
        super(context);
    }

    public ZKPrepareView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKPrepareView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
