 ...
 * 手势控制
 */
public class ZKGestureView extends FrameLayout implements IGestureComponent {

    public ZKGestureView(@NonNull Context context) {
        super(context);
    }

    public ZKGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKGestureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
