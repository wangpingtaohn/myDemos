 ...
 * 播放器顶部标题栏
 */
public class ZKTitleView extends FrameLayout implements IControlComponent {
    ...
    public ZKTitleView(@NonNull Context context) {
        super(context);
    }

    public ZKTitleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKTitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
