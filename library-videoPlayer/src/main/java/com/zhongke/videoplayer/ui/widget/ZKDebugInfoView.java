 ...
 * 调试信息
 */
public class ZKDebugInfoView extends AppCompatTextView implements IControlComponent {

    private ControlWrapper mControlWrapper;

    public ZKDebugInfoView(Context context) {
        super(context);
    }

    public ZKDebugInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKDebugInfoView(Context context, AttributeSet attrs, int defStyleAttr) {
