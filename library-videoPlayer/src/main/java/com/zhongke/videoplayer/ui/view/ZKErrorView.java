...
import com.zhongke.videoplayer.ui.utils.NetworkUtilVideo;
 ...
 */
public class ZKErrorView extends LinearLayout implements IControlComponent {
    ...
    public ZKErrorView(Context context) {
        this(context, null);
    }

    public ZKErrorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZKErrorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...

    {
        ...
        findViewById(R.id.status_btn).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!NetworkUtilVideo.isNetworkAvailable(getContext())) {
                    Toast.makeText(getContext(),"当前网络异常\n" +
