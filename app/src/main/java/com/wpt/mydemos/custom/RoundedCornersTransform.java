...
public class RoundedCornersTransform implements Transformation<Bitmap> {
    ...
    private int mMargin;
    private RoundedCornersTransform.CornerType mCornerType;

    public RoundedCornersTransform(Context context, int radius, int margin) {
        this(context, radius, margin, RoundedCornersTransform.CornerType.ALL);
    }

    public RoundedCornersTransform(BitmapPool pool, int radius, int margin) {
        this(pool, radius, margin, RoundedCornersTransform.CornerType.ALL);
    }

    public RoundedCornersTransform(Context context, int radius, int margin,
                                   RoundedCornersTransform.CornerType cornerType) {
